...
export default async function BagRoute() {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-10 min-h-[55vh]">
      {!cart || !cart.items ? (
        <div className="min-h-[400px] flex flex-col items-center justify-center rounded-lg border border-dashed mt-20 p-8 text-center">
          ...
          <p className="mb-8 mt-2 text-center text-sm leading-6 text-muted-foreground max-w-sm mx-auto">
            ...
            Please add some products ao that you can see them right here
          </p>
          <Button asChild>
