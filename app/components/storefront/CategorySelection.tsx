...
export default function CategoriesSelection() {
  return (
    <div className="py-24 sm:py-32">
      ...
      <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-y-6 sm:grid-rows-2 sm:gap-x-6 lg:gap-8">
        ...
        <div className="group aspect-w-2 aspect-h-1 rounded-lg overflow-hidden sm:relative sm:aspect-none sm:h-full">
          <Image
            ...
            className="object-bottom object-cover sm:absolute sm:inset-0 sm:h-full sm:w-full"
          />
